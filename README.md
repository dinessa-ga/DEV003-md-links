...
* Este proyecto contiene pruebas unitarias cubren statements, functions,
  lines, y branches.

### Planificación

Para la planificación de este proyecto se utilizó la herramienta de planificación y organización de GitHub llamada **Github Projects**, luego de la elaboración del diagrama de flujo, se utilizó asignaron **issues** y **milestones**
